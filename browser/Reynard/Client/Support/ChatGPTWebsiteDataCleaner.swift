...
enum ChatGPTWebsiteDataCleaner {
    private static let purgeVersion = "chatgpt-shell-cache-v40"
    ...
    private static func clearLaunchCaches() {
        ...
        let libraryURL = URL(fileURLWithPath: NSHomeDirectory(), isDirectory: true)
    ...
    private static func shouldRemoveFile(name: String, path: String) -> Bool {
        ...
        return serviceWorkerFileNames.contains(name) ||
            name.contains("cachestorage") ||
